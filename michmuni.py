...
class Michmuni(BotPlugin):
    """
    Search for Michigan municipal unit, given and address.
    """
    ...
    def deactivate(self):
        ...
        You should delete it if you're not using it to override any default behaviour
        """
        super(Michmuni, self).deactivate()
    ...
    def check_configuration(self, configuration):
        ...
        You should delete it if you're not using it to override any default behaviour
        """
        super(Michmuni, self).check_configuration(configuration)
